...
public class TurnTransHandlerProvider implements TransHandlerProvider {

	private static final String TIME = "time";
	private static final String BGCOLOR = "bgcolor";
	protected long[] mLogValueRet;

	public TurnTransHandlerProvider() {
	...
	public BaseTransHandler startTransition(SimpleOptionProvider options,
		...
		// retrieve "bgcolor" option
		er = options.getAsNumber( BGCOLOR, mLogValueRet );
		int bgcolor = (int) mLogValueRet[0];
		if( er < 0 ) bgcolor = 0;

		// オブジェクトを作成
		return new TurnTransHandler(time, src1w, src1h, bgcolor);
	}
