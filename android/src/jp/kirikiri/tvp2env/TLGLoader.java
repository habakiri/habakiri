...
public class TLGLoader {
	...
	static public final Bitmap loadTLG( BinaryStream src, int mode, HashMap<String,String> metainfo ) throws TJSException {
		Bitmap result = null;
	...
	private static final Bitmap internalLoadTLG(BinaryStream src, int mode, HashMap<String,String> metainfo) throws TJSException {
		// read header
		byte[] mark = new byte[11];
		src.read(mark);
	...
	public static final Bitmap LoadTLG5(BinaryStream src, int mode, HashMap<String,String> metainfo) throws TJSException {
		...
		*/
		...
		bmp.setPixels( imagedata, 0, width, 0, 0, width, height );
		imagedata = null;
		//return Bitmap.createBitmap( imagedata, 0, width, width, height, Bitmap.Config.ARGB_8888 );
		return bmp;
	}
	...
	public static final Bitmap LoadTLG6(BinaryStream src, int mode, HashMap<String,String> metainfo) throws TJSException {
