...
public class MosaicTransHandlerProvider implements TransHandlerProvider {

	private static final String TIME = "time";
	private static final String MAXSIZE = "maxsize";
	protected long[] mLogValueRet;

	public MosaicTransHandlerProvider() {
		mLogValueRet = new long[1];
	}

	@Override
	public String getName() { return "mosaic"; }
	...
	public BaseTransHandler startTransition(SimpleOptionProvider options,
		...
		// retrieve "maxblocksize" option
		er = options.getAsNumber( MAXSIZE, mLogValueRet );
		int maxblocksize = (int) mLogValueRet[0];
		if( er < 0 ) maxblocksize = 30;

		// オブジェクトを作成
		return new MosaicTransHandler(time, src1w, src1h, maxblocksize);
	}
